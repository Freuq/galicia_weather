...
####################################################### PRECIPITACIÓN #######################################################
st.markdown(
    f"<h2 style='text-align: center;'>☔<a href='/01_☔_Choiva' target='_self' style='color: #ffffff;'>Choiva en {localizacion}</a></h2>",
...
################################################### TEMPERATURA #######################################################
st.markdown(
    f"<h2 style='text-align: center;'>🌡️<a href='/02_🌡️_Temperatura' target='_self' style='color: #ffffff;'>Temperatura en {localizacion}</a></h2>",
    unsafe_allow_html=True
)
...
########################################### HUMEDAD RELATIVA #######################################################
st.markdown(
    f"<h2 style='text-align: center;'>🌫️<a href='/03_🌫️_Humidade' target='_self' style='color: #ffffff;'>Humidade Relativa en {localizacion}</a></h2>",
    unsafe_allow_html=True
)
