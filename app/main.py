...
####################################################### PRECIPITACIÓN #######################################################
st.markdown(
    f"<h2 style='text-align: center;'>☔<a href='/01_Choiva' target='_self' style='color: #ffffff;'>Choiva en {localizacion}</a></h2>",
...
################################################### TEMPERATURA #######################################################
st.markdown(
    f"<h2 style='text-align: center;'>🌡️<a href='/02_Temperatura' target='_self' style='color: #ffffff;'>Temperatura en {localizacion}</a></h2>",
    unsafe_allow_html=True
)
